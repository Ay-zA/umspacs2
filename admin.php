<?php
  ...
  require_once 'src/components/php/api/admin.php';
...
?>
  ...
  <body>
    ...
    <div class="flex-container">
      ...
      <div id="basic-info" class="main-panel" style="display:none;">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10 inputGroupContainer">
                  <div class="input-group">
                    ...
                    <input name="usern_name" readonly placeholder="Username" class="form-control" type="text">
                  </div>
                </div>
              </div>
              <!-- Text input-->
              ...
              <div class="form-group">
                ...
                <div class="col-md-10 inputGroupContainer">
                  <div class="input-group">
                    ...
                    <input name="repeat_password" placeholder="E-Mail Address" class="form-control" type="text">
                  </div>
                </div>
              </div>
      ...
      <div id="admin-panel" class="main-panel">
        <div class="container-fluid">
          <div class="row">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10 inputGroupContainer">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input name="usern_name" placeholder="Username" class="form-control" type="text">
                      </div>
                    </div>
                  </div>
                  <!-- Text input-->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <button type="submit" class="btn btn-block btn-warning">Create <span class="glyphicon glyphicon-send"></span></button>
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3>Modlities:</h3>
              <table id="mod-table" class="table table-striped">
                <thead>
                  <tr>
                    <th>Name</th>
                    <th>Info</th>
